...
export interface StyleConfig {
  ...
  jsEntry: {
    ...
    entry: string[];
    /**
     * Whether to automatically inject Block UI library style dependency into style entry file
     * @zh 是否自动注入所依赖的 Block 组件样式
     * @e.g @import '~@block-org/block-ui/esm/button/style';
     * @default true
     */
    autoInjectBlockDep: boolean;
    /**
